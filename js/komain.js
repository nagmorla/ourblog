function HomeModel() {
    ...
    var topic = {'subject': 'Artificial Inteligence :: Robot is very dangorous', 'content': 'A robot is a machine—especially one programmable by a computer— capable of carrying out a complex series of actions automatically. '};
    self.topics.push(topic);

    topic = {'subject': 'Machine Learning:: Linear regression is difficult to understand', 'content': 'Make better decisions utilizing linear regression techniques. Learn more today. Leverage IBM® SPSS for simple linear regression. '};
    self.topics.push(topic);
